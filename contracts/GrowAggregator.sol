...
contract GrowAggregator is SpecialTransferHelper, Ownable, ReentrancyGuard {
    ...
    function batchBuyWithETHCall(
        address[] calldata market,
        uint256[] calldata nextMarketOrderIndex,
        TradeDetails[] calldata trades
    ...
    function batchBuyWithERC20sCall(
        ERC20Details memory erc20Details,
        address[] calldata market,
        uint256[] calldata nextMarketOrderIndex,
        TradeDetails[] calldata trades,
    ...
    function tradeLoop(address[] memory market, uint256[] memory nextMarketOrderIndex, TradeDetails[] memory trades) internal{
        uint256 mi;
    ...
    //deprecated
    function batchBuyFromOpenSeaV1(
