...
import "./MoonCatsRescue.sol";
import "./MoonCatsWrapped.sol";
...
contract MoonCatOrderLookup is Ownable {
    ...
    MoonCatsRescue MCR = MoonCatsRescue(0x60cd862c9C687A9dE49aecdC3A99b74A4fc54aB6);
    ...
    //         uint256 oldTokenId = OLD_MCRW.(_owner, i);
