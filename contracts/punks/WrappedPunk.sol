...
import "./interfaces/ICryptoPunk.sol";
...
contract WrappedPunk is Ownable, ERC721Full, Pausable {
     ...
     */
    constructor(address punkContractAddress)
        ERC721Full("Wrapped Cryptopunks", "WPUNKS","")
    {
        _punkContract = ICryptoPunk(punkContractAddress);
    }
    ...
    function _transferFrom(address from, address to, uint256 punkIndex)
        ...
        whenNotPaused
    {
        super.transferFrom(from, to, punkIndex);
    }
